...
public class Person implements Artist, Curator {
	...
	@OneToMany(mappedBy = "curator", cascade = { CascadeType.DETACH, CascadeType.PERSIST, CascadeType.REFRESH })
	...
	@OneToMany(mappedBy = "artist", cascade = { CascadeType.DETACH, CascadeType.REMOVE, CascadeType.PERSIST,
			CascadeType.REFRESH })
...
//---------------------------ARTIST-------------------------------
	...
	public void setIndividualExhibitions(Set<IndividualExhibition> individualExhibitions) {
		this.individualExhibitions = individualExhibitions;
	}
